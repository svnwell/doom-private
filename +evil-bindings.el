;;; config/private/+evil-bindings.el -*- lexical-binding: t; -*-
...
(map! :leader
      ...
      :desc "mark down"             "SPC"  #'set-mark-command
      ...
      (:prefix-map ("c" . "code")
        ...
        :desc "Comment/UnComment lines"     "i"   #'evilnc-comment-or-uncomment-lines
        :desc "Comment/UnComment para"      "p"   #'evilnc-comment-or-uncomment-paragraphs
        :desc "Comment/UnComment region"    "s"   #'evilnc-comment-or-uncomment-region)
